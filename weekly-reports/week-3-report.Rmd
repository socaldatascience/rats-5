...
neuron_36_spikes_o1 <-
  em_trials %>% 
  filter(trial %in% odor_1_trials) %>% 
  select(time_bin, trial, odor_1, neuron_28) %>% 
  group_by(trial) %>% 
  mutate(time_bin = time_bin - min(time_bin)) %>% 
  filter(neuron_28 == 1) %>% 
  ggplot(aes(x = time_bin)) + 
...
neuron_36_spikes_o2 <-
  em_trials %>% 
  filter(trial %in% odor_2_trials) %>% 
  select(time_bin, trial, odor_2, neuron_28) %>% 
  group_by(trial) %>% 
  mutate(time_bin = time_bin - min(time_bin)) %>% 
  filter(neuron_28 == 1) %>% 
  ggplot(aes(x = time_bin)) + 
...
neuron_36_spikes_o3 <-
  em_trials %>% 
  filter(trial %in% odor_3_trials) %>% 
  select(time_bin, trial, odor_3, neuron_28) %>% 
  group_by(trial) %>% 
  mutate(time_bin = time_bin - min(time_bin)) %>% 
  filter(neuron_28 == 1) %>% 
  ggplot(aes(x = time_bin)) + 
...
neuron_36_spikes_o4 <-
  em_trials %>% 
  filter(trial %in% odor_4_trials) %>% 
  select(time_bin, trial, odor_4, neuron_28) %>% 
  group_by(trial) %>% 
  mutate(time_bin = time_bin - min(time_bin)) %>% 
  filter(neuron_28 == 1) %>% 
  ggplot(aes(x = time_bin)) + 
...
neuron_36_spikes_o5 <-
  em_trials %>% 
  filter(trial %in% odor_5_trials) %>% 
  select(time_bin, trial, odor_5, neuron_28) %>% 
  group_by(trial) %>% 
  mutate(time_bin = time_bin - min(time_bin)) %>% 
  filter(neuron_28 == 1) %>% 
  ggplot(aes(x = time_bin)) + 
