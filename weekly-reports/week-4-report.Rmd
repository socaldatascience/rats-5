...
pog_model <- multinom(odor ~ .,
                      data = test)

model_1 <- multinom(odor ~ .,
                    data = odor_a_test)

model_2 <- multinom(odor ~ .,
                    data = odor_b_test)

model_3 <- multinom(odor ~ .,
                    data = odor_c_test)

model_4 <- multinom(odor ~ .,
                    data = odor_d_test)

model_5 <- multinom(odor ~ .,
                    data = odor_e_test)
...
info_1 <- broom::tidy(model_1,conf.int=TRUE)
info_1 <- dplyr::filter(info_1, term!="(Intercept)")

info_2 <- broom::tidy(model_2,conf.int=TRUE)
info_2 <- dplyr::filter(info_2, term!="(Intercept)")

info_3 <- broom::tidy(model_3,conf.int=TRUE)
info_3 <- dplyr::filter(info_3, term!="(Intercept)")

info_4 <- broom::tidy(model_4,conf.int=TRUE)
info_4 <- dplyr::filter(info_4, term!="(Intercept)")

info_5 <- broom::tidy(model_5,conf.int=TRUE)
info_5 <- dplyr::filter(info_5, term!="(Intercept)")
