...
__Examining Firing Patterns Over Sequences of Trials By Odor__

```{r}
em_trials %>% 
  select(time_bin, trial, odor_1, odor_2, odor_3, odor_4, odor_5, neuron_2) %>% 
  filter(trial != 0 & neuron_2 == 1 & odor_1 == 1)
```
